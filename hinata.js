...
Selama ${clockString(new Date - user.afkTime)}`)
	    ...
	    case 'donasi': case 'donate': {
                m.reply(`*Jangan Lupa Donasi Ngab*\n\nSaweria\n• ${global.donasi.saweria}\n\n(Dana/Gopay/Pulsa)\n• ${global.donasi.nomor}\n\n*Thank you!*`)
            }
            break
            case 'sc': {
 ...
 *Group Menu*
 ...
 • ${prefix}ꜱᴇᴛᴘᴘɢᴄ [image]
 • ${prefix}ꜱᴇᴛɴᴀᴍᴇ [text]
 • ${prefix}ꜱᴇᴛᴅᴇꜱᴄ [text]
 • ${prefix}ɢʀᴏᴜᴘ [option]
 • ${prefix}ᴇᴅɪᴛɪɴꜰᴏ [option]
 • ${prefix}ᴀᴅᴅ @user
 • ${prefix}ᴋɪᴄᴋ @user
 • ${prefix}ʜɪᴅᴇᴛᴀɢ [text]
 • ${prefix}ᴛᴀɢᴀʟʟ [text]
 ...
 *Downloader Menu*
 • ${prefix}ᴛɪᴋᴛᴏᴋɴᴏᴡᴍ [url]
 • ${prefix}ᴛɪᴋᴛᴏᴋᴡᴍ [url]
 • ${prefix}ᴛɪᴋᴛᴏᴋᴍᴘ3 [url]
 • ${prefix}ʏᴛᴍᴘ3 [url]
 • ${prefix}ʏᴛᴍᴘ4 [url]
 • ${prefix}ɢᴇᴛᴍᴜꜱɪᴄ [query]
